...
import 'package:mentorkhoj/helper/notification_helper.dart';
...
import 'package:mentorkhoj/features/chat/widgets/message_bubble_widget.dart';
import 'package:mentorkhoj/features/chat/widgets/message_bubble_shimmer_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      ResponsiveHelper.isMobilePhone() && isAdmin && !widget.isAppBar ? null : AppBar(
        title: isAdmin ? Text('${Provider.of<SplashProvider>(context,listen: false).configModel!.ecommerceName}')
